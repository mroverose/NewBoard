...
WBWindowsMediaFile::WBWindowsMediaFile(QObject * pParent)
    : QObject(pParent)
   // , mWMhDC(0)
  //  , mWMWriter(0)
  //  , mPushSink(0)
...
bool WBWindowsMediaFile::init(const QString& videoFileName, const QString& profileData, int pFramesPerSecond
...
WBWindowsMediaFile::~WBWindowsMediaFile()
{
    // NOOP
}


void WBWindowsMediaFile::releaseWMObjects()
{
/*
...
bool WBWindowsMediaFile::initVideoStream(int nFrameWidth, int nFrameHeight, int nBitsPerPixel)
{
   /* BITMAPINFO bmpInfo;
...
bool WBWindowsMediaFile::appendVideoFrame(const QImage& pImage, long mstimestamp)
{
    /*
...
//void WBWindowsMediaFile::appendAudioBuffer(WAVEHDR *buffer, long mstimestamp)
//{
    /*
    INSSBuffer *sampleBuffer = 0;
...
void WBWindowsMediaFile::startNewChapter(const QString& pLabel, long timestamp)
{
    /*
    MarkerInfo mi;
    mi.label = pLabel;
...
void WBWindowsMediaFile::setLastErrorMessage(const QString& error)
{
