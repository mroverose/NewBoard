...
bool WBCFFAdaptor::compressDir(const QString &dirName, const QString &parentDir)
{
...
bool WBCFFAdaptor::compressFile(const QString &fileName, const QString &parentDir)
{
